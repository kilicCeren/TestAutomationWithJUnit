...
public class C05_IFrame extends TestBaseEach {
    ...
    public void test01(){
        ...
        WebElement playTusu = driver.findElement(By.xpath("//*[@class='ytp-large-play-button ytp-button ytp-large-play-button-red-bg']")); //-//*[@aria-label='Play'] bu xpath farklı dillerde değişiklik gösterebiliyor o yüzden tercih etmedim.
        playTusu.click();
